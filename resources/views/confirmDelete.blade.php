                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                            <form method="POST" class="mt-5 mb-5 login-input">
                                                @csrf
                                                <center><hr> <h1 class="day-4"> Delete User  </h1>  </center>
                                                <hr>
                                                <center>
                                                <p class="mt-5 login-form__footer"> Are you sure to delete this User ?
                                                 </p>
                                               
                                                <br>
                                                <a href="/userlist"> <input type="Decline" value="Decline" class="btn">
                                                 </a>
                                                <br>
                                                <br>
